...
void TaskStatusChartWidget::updateChartWidget(QList<int> taskCountList, QStringList statuses)
{
    qDeleteAll(this->children());

    QVBoxLayout* mainLayout = new QVBoxLayout(this);
    mainLayout->setContentsMargins(0, 0, 0, 0);
        QtCharts::QChartView* chartWidget = this->buildChart(m_chartLabel, m_setLabel, taskCountList, statuses);
        mainLayout->addWidget(chartWidget);
    this->setLayout(mainLayout);
}

QtCharts::QChartView* TaskStatusChartWidget::buildChart(QString chartLabel, QString setLabel, QList<int> taskCountList, QStringList statuses)
{
